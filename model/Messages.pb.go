...
type MyShortNumber struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *MyShortNumber) Reset() {
	*x = MyShortNumber{}
	if protoimpl.UnsafeEnabled {
...
func (x *MyShortNumber) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MyShortNumber) ProtoMessage() {}

func (x *MyShortNumber) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MyShortNumber.ProtoReflect.Descriptor instead.
func (*MyShortNumber) Descriptor() ([]byte, []int) {
...
type LookupShortNumber struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IdentityKey []byte `protobuf:"bytes,1,opt,name=identityKey,proto3" json:"identityKey,omitempty"` // the identity key for which to look up the short number
}

func (x *LookupShortNumber) Reset() {
	*x = LookupShortNumber{}
	if protoimpl.UnsafeEnabled {
...
func (x *LookupShortNumber) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LookupShortNumber) ProtoMessage() {}

func (x *LookupShortNumber) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LookupShortNumber.ProtoReflect.Descriptor instead.
func (*LookupShortNumber) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{19}
}

func (x *LookupShortNumber) GetIdentityKey() []byte {
	if x != nil {
		return x.IdentityKey
	}
	return nil
...
type ShortNumberResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ShortNumber string `protobuf:"bytes,1,opt,name=shortNumber,proto3" json:"shortNumber,omitempty"` // a short form of IdentityKey encoded in base810
	Domain      string `protobuf:"bytes,2,opt,name=domain,proto3" json:"domain,omitempty"`           // the domain within which the short number is registered
}

func (x *ShortNumberResponse) Reset() {
	*x = ShortNumberResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShortNumberResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShortNumberResponse) ProtoMessage() {}

func (x *ShortNumberResponse) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShortNumberResponse.ProtoReflect.Descriptor instead.
func (*ShortNumberResponse) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{20}
}

func (x *ShortNumberResponse) GetShortNumber() string {
	if x != nil {
...
func (x *ShortNumberResponse) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
type LookupIdentityKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ShortNumber string `protobuf:"bytes,1,opt,name=shortNumber,proto3" json:"shortNumber,omitempty"` // the short number for which to look up the full IdentityKey
}

func (x *LookupIdentityKey) Reset() {
	*x = LookupIdentityKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *LookupIdentityKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LookupIdentityKey) ProtoMessage() {}

func (x *LookupIdentityKey) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LookupIdentityKey.ProtoReflect.Descriptor instead.
func (*LookupIdentityKey) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{21}
}

func (x *LookupIdentityKey) GetShortNumber() string {
	if x != nil {
		return x.ShortNumber
	}
	return ""
...
type LookupIdentityKeyResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IdentityKey []byte `protobuf:"bytes,1,opt,name=identityKey,proto3" json:"identityKey,omitempty"` // the matching IdentityKey (if one was found)
}

func (x *LookupIdentityKeyResponse) Reset() {
	*x = LookupIdentityKeyResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *LookupIdentityKeyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LookupIdentityKeyResponse) ProtoMessage() {}

func (x *LookupIdentityKeyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LookupIdentityKeyResponse.ProtoReflect.Descriptor instead.
func (*LookupIdentityKeyResponse) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{22}
}

func (x *LookupIdentityKeyResponse) GetIdentityKey() []byte {
	if x != nil {
		return x.IdentityKey
	}
	return nil
...
type Message struct {
	...
	//	*Message_MyShortNumber
	//	*Message_LookupShortNumber
	//	*Message_ShortNumberResponse
	//	*Message_LookupIdentityKey
	//	*Message_LookupIdentityKeyResponse
...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_Messages_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{23}
}
...
func (x *Message) GetMyShortNumber() *MyShortNumber {
	if x, ok := x.GetPayload().(*Message_MyShortNumber); ok {
		return x.MyShortNumber
	}
	return nil
}

func (x *Message) GetLookupShortNumber() *LookupShortNumber {
	if x, ok := x.GetPayload().(*Message_LookupShortNumber); ok {
		return x.LookupShortNumber
	}
	return nil
}

func (x *Message) GetShortNumberResponse() *ShortNumberResponse {
	if x, ok := x.GetPayload().(*Message_ShortNumberResponse); ok {
		return x.ShortNumberResponse
	}
	return nil
}

func (x *Message) GetLookupIdentityKey() *LookupIdentityKey {
	if x, ok := x.GetPayload().(*Message_LookupIdentityKey); ok {
		return x.LookupIdentityKey
	}
	return nil
}

func (x *Message) GetLookupIdentityKeyResponse() *LookupIdentityKeyResponse {
	if x, ok := x.GetPayload().(*Message_LookupIdentityKeyResponse); ok {
		return x.LookupIdentityKeyResponse
	}
	return nil
}
...
type Message_MyShortNumber struct {
	MyShortNumber *MyShortNumber `protobuf:"bytes,17,opt,name=myShortNumber,proto3,oneof"`
}

type Message_LookupShortNumber struct {
	LookupShortNumber *LookupShortNumber `protobuf:"bytes,18,opt,name=lookupShortNumber,proto3,oneof"`
}

type Message_ShortNumberResponse struct {
	ShortNumberResponse *ShortNumberResponse `protobuf:"bytes,19,opt,name=shortNumberResponse,proto3,oneof"`
}

type Message_LookupIdentityKey struct {
	LookupIdentityKey *LookupIdentityKey `protobuf:"bytes,20,opt,name=lookupIdentityKey,proto3,oneof"`
}

type Message_LookupIdentityKeyResponse struct {
	LookupIdentityKeyResponse *LookupIdentityKeyResponse `protobuf:"bytes,21,opt,name=lookupIdentityKeyResponse,proto3,oneof"`
}
...
func (*Message_MyShortNumber) isMessage_Payload() {}

func (*Message_LookupShortNumber) isMessage_Payload() {}

func (*Message_ShortNumberResponse) isMessage_Payload() {}

func (*Message_LookupIdentityKey) isMessage_Payload() {}

func (*Message_LookupIdentityKeyResponse) isMessage_Payload() {}
...
func (x *ForwardedMessage) Reset() {
	*x = ForwardedMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_Messages_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ForwardedMessage) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{24}
}
...
var file_model_Messages_proto_rawDesc = []byte{
	...
	,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x74, 0x61, 0x73, 0x73, 0x69, 0x73, 0x2e,
	...
	,
...
var file_model_Messages_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_model_Messages_proto_goTypes = []interface{}{
	...
	(*MyShortNumber)(nil),               // 18: tassis.MyShortNumber
	(*LookupShortNumber)(nil),           // 19: tassis.LookupShortNumber
	(*ShortNumberResponse)(nil),         // 20: tassis.ShortNumberResponse
	(*LookupIdentityKey)(nil),           // 21: tassis.LookupIdentityKey
	(*LookupIdentityKeyResponse)(nil),   // 22: tassis.LookupIdentityKeyResponse
	(*Message)(nil),                     // 23: tassis.Message
	(*ForwardedMessage)(nil),            // 24: tassis.ForwardedMessage
	nil,                                 // 25: tassis.UploadAuthorization.UploadFormDataEntry
}
var file_model_Messages_proto_depIdxs = []int32{
	...
	25, // 3: tassis.UploadAuthorization.uploadFormData:type_name -> tassis.UploadAuthorization.UploadFormDataEntry
	...
	18, // 19: tassis.Message.myShortNumber:type_name -> tassis.MyShortNumber
	19, // 20: tassis.Message.lookupShortNumber:type_name -> tassis.LookupShortNumber
	20, // 21: tassis.Message.shortNumberResponse:type_name -> tassis.ShortNumberResponse
	21, // 22: tassis.Message.lookupIdentityKey:type_name -> tassis.LookupIdentityKey
	22, // 23: tassis.Message.lookupIdentityKeyResponse:type_name -> tassis.LookupIdentityKeyResponse
	13, // 24: tassis.ForwardedMessage.message:type_name -> tassis.OutboundMessage
...
func file_model_Messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_Messages_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LookupShortNumber); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_Messages_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShortNumberResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_Messages_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LookupIdentityKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_Messages_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LookupIdentityKeyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_Messages_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_model_Messages_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
	...
	file_model_Messages_proto_msgTypes[23].OneofWrappers = []interface{}{
		(*Message_Ack)(nil),
		(*Message_Error)(nil),
		...
		(*Message_MyShortNumber)(nil),
		(*Message_LookupShortNumber)(nil),
		(*Message_ShortNumberResponse)(nil),
		(*Message_LookupIdentityKey)(nil),
		(*Message_LookupIdentityKeyResponse)(nil),
	}
	type x struct{}
