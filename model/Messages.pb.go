...
type Error struct {
	...
	Name        string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`               // An identifier for the error, like "unknown_user"
...
type Address struct {
	...
	UserID   []byte `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`      // The 33 byte user ID, which is also the user's public key. It consists of a 1 byte type (always 0x05) followed by 32 bits of ed25519 public key
	DeviceID uint32 `protobuf:"varint,2,opt,name=deviceID,proto3" json:"deviceID,omitempty"` // Identifier for a specific user device, only unique for a given userID
}
...
type AuthResponse struct {
	...
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"` // A signature of the serialized Login message calculated using the private key corresponding to the UserID that's logging in
}
...
type Register struct {
	...
	RegistrationID uint32   `protobuf:"varint,1,opt,name=registrationID,proto3" json:"registrationID,omitempty"` // The local registrationID for this device.
	SignedPreKey   []byte   `protobuf:"bytes,2,opt,name=signedPreKey,proto3" json:"signedPreKey,omitempty"`      // The signedPreKey for this device.
	OneTimePreKeys [][]byte `protobuf:"bytes,3,rep,name=oneTimePreKeys,proto3" json:"oneTimePreKeys,omitempty"`  // Zero, one or more disposable preKeys for this device.
}
...
type RequestPreKeys struct {
	...
	UserID         []byte   `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                         // The UserID for which to retrieve preKeys.
	KnownDeviceIDs []uint32 `protobuf:"varint,2,rep,packed,name=knownDeviceIDs,proto3" json:"knownDeviceIDs,omitempty"` // Devices which the client already knows about and doesn't need preKeys for.
}
...
func (x *PreKey) GetAddress() *Address {
	if x != nil {
		return x.Address
	}
	return nil
...
var file_model_Messages_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x28, 0x0a, 0x0e, 0x69, 0x6e, 0x62, 0x6f, 0x75, 0x6e,
	0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00,
	0x52, 0x0e, 0x69, 0x6e, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x87, 0x01, 0x0a, 0x10,
	0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	,
...
var file_model_Messages_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_model_Messages_proto_goTypes = []interface{}{
	...
	(*Message)(nil),          // 13: tassis.Message
	(*ForwardedMessage)(nil), // 14: tassis.ForwardedMessage
}
var file_model_Messages_proto_depIdxs = []int32{
	2,  // 0: tassis.Login.address:type_name -> tassis.Address
	2,  // 1: tassis.PreKey.address:type_name -> tassis.Address
	9,  // 2: tassis.PreKeys.preKeys:type_name -> tassis.PreKey
	2,  // 3: tassis.OutboundMessage.to:type_name -> tassis.Address
	...
	12, // 14: tassis.ForwardedMessage.message:type_name -> tassis.OutboundMessage
...
func file_model_Messages_proto_init() {
	...
	file_model_Messages_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*Message_Ack)(nil),
		(*Message_Error)(nil),
