...
type FindChatNumberByShortNumber struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ShortNumber string `protobuf:"bytes,1,opt,name=shortNumber,proto3" json:"shortNumber,omitempty"` // the short number for which to look up the ChatNumber
}

func (x *FindChatNumberByShortNumber) Reset() {
	*x = FindChatNumberByShortNumber{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindChatNumberByShortNumber) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindChatNumberByShortNumber) ProtoMessage() {}

func (x *FindChatNumberByShortNumber) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindChatNumberByShortNumber.ProtoReflect.Descriptor instead.
func (*FindChatNumberByShortNumber) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{18}
}

func (x *FindChatNumberByShortNumber) GetShortNumber() string {
	if x != nil {
...
type FindChatNumberByIdentityKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IdentityKey []byte `protobuf:"bytes,1,opt,name=identityKey,proto3" json:"identityKey,omitempty"` // the identity key for which to look up the ChatNumber
}

func (x *FindChatNumberByIdentityKey) Reset() {
	*x = FindChatNumberByIdentityKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindChatNumberByIdentityKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindChatNumberByIdentityKey) ProtoMessage() {}

func (x *FindChatNumberByIdentityKey) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindChatNumberByIdentityKey.ProtoReflect.Descriptor instead.
func (*FindChatNumberByIdentityKey) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{19}
}

func (x *FindChatNumberByIdentityKey) GetIdentityKey() []byte {
	if x != nil {
		return x.IdentityKey
	}
	return nil
...
func (x *ChatNumber) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChatNumber) ProtoMessage() {}

func (x *ChatNumber) ProtoReflect() protoreflect.Message {
	mi := &file_model_Messages_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChatNumber.ProtoReflect.Descriptor instead.
func (*ChatNumber) Descriptor() ([]byte, []int) {
	return file_model_Messages_proto_rawDescGZIP(), []int{20}
}

func (x *ChatNumber) GetNumber() string {
	if x != nil {
		return x.Number
	}
	return ""
...
func (x *ChatNumber) GetShortNumber() string {
	if x != nil {
		return x.ShortNumber
	}
	return ""
...
func (x *ChatNumber) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
type Message struct {
	...
	//	*Message_FindChatNumberByShortNumber
	//	*Message_FindChatNumberByIdentityKey
	//	*Message_ChatNumber
...
func (x *Message) GetFindChatNumberByShortNumber() *FindChatNumberByShortNumber {
	if x, ok := x.GetPayload().(*Message_FindChatNumberByShortNumber); ok {
		return x.FindChatNumberByShortNumber
	}
	return nil
}

func (x *Message) GetFindChatNumberByIdentityKey() *FindChatNumberByIdentityKey {
	if x, ok := x.GetPayload().(*Message_FindChatNumberByIdentityKey); ok {
		return x.FindChatNumberByIdentityKey
	}
	return nil
}

func (x *Message) GetChatNumber() *ChatNumber {
	if x, ok := x.GetPayload().(*Message_ChatNumber); ok {
		return x.ChatNumber
	}
	return nil
}
...
type Message_FindChatNumberByShortNumber struct {
	FindChatNumberByShortNumber *FindChatNumberByShortNumber `protobuf:"bytes,17,opt,name=findChatNumberByShortNumber,proto3,oneof"`
}

type Message_FindChatNumberByIdentityKey struct {
	FindChatNumberByIdentityKey *FindChatNumberByIdentityKey `protobuf:"bytes,18,opt,name=findChatNumberByIdentityKey,proto3,oneof"`
}

type Message_ChatNumber struct {
	ChatNumber *ChatNumber `protobuf:"bytes,19,opt,name=chatNumber,proto3,oneof"`
}
...
func (*Message_FindChatNumberByShortNumber) isMessage_Payload() {}

func (*Message_FindChatNumberByIdentityKey) isMessage_Payload() {}

func (*Message_ChatNumber) isMessage_Payload() {}
...
var file_model_Messages_proto_rawDesc = []byte{
	...
	0x22, 0x3f, 0x0a, 0x1b, 0x46, 0x69, 0x6e, 0x64, 0x43, 0x68, 0x61, 0x74, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x42, 0x79, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12,
	...
	,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x74, 0x61, 0x73, 0x73, 0x69, 0x73, 0x2e,
	...
	0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10,
	...
	0x75, 0x6e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
	...
	0x4b, 0x65, 0x79, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x74, 0x61, 0x73,
	...
	0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x74, 0x61, 0x73, 0x73, 0x69, 0x73, 0x2e, 0x50,
	...
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x74, 0x61, 0x73, 0x73, 0x69, 0x73, 0x2e, 0x50,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x74,
	...
	0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c,
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	...
	,
...
var file_model_Messages_proto_goTypes = []interface{}{
	...
	(*FindChatNumberByShortNumber)(nil), // 18: tassis.FindChatNumberByShortNumber
	(*FindChatNumberByIdentityKey)(nil), // 19: tassis.FindChatNumberByIdentityKey
	(*ChatNumber)(nil),                  // 20: tassis.ChatNumber
...
var file_model_Messages_proto_depIdxs = []int32{
	...
	18, // 19: tassis.Message.findChatNumberByShortNumber:type_name -> tassis.FindChatNumberByShortNumber
	19, // 20: tassis.Message.findChatNumberByIdentityKey:type_name -> tassis.FindChatNumberByIdentityKey
	20, // 21: tassis.Message.chatNumber:type_name -> tassis.ChatNumber
...
func file_model_Messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_Messages_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindChatNumberByShortNumber); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_Messages_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindChatNumberByIdentityKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_model_Messages_proto_msgTypes[21].OneofWrappers = []interface{}{
		...
		(*Message_FindChatNumberByShortNumber)(nil),
		(*Message_FindChatNumberByIdentityKey)(nil),
		(*Message_ChatNumber)(nil),
	}
	type x struct{}
